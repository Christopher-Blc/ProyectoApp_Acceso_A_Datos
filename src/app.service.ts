    ...
    <section id="inicio" class="min-h-screen flex flex-col items-center justify-center pt-20 px-6 text-center">
        <div data-aos="fade-up">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="/public/respi.apk" download="respi.apk" class="px-8 py-4 btn-brand transition-all rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-[#F5CA7E]/20 transform hover:scale-105">
