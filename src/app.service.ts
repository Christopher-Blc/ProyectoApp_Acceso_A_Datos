    ...
    <section id="inicio" class="min-h-screen flex flex-col items-center justify-center pt-20 px-6 text-center">
        <div data-aos="fade-up">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="/api/public/ResPi_dev1.0.2.apk" download="ResPi_dev1.0.2.apk" class="px-8 py-4 btn-brand transition-all rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-[#F5CA7E]/20 transform hover:scale-105">
                ...
                <a href="/api/swagger" class="px-8 py-4 glass text-white hover:bg-white/5 transition-all rounded-xl font-bold border border-white/10">
                    API Documentation
                </a>
            </div>
        </div>
