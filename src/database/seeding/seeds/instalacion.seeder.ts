import { Instalacion, estado_instalacion } from "../../../modules/instalacion/entities/instalacion.entity";
...
export class InstalacionSeeder implements Seeder {
    public async run(dataSource: DataSource): Promise<any> {
        ...
        for (const item of instalacionData) {
            ...
            instalacionEntry.fecha_creacion = item.fecha_creacion ? new Date(item.fecha_creacion) : new Date();
